...
class Student:
    ...
    # This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome To Student Pannel",font=("times new roman",30,"bold"),bg="white",fg="navyblue")
        ...
        left_frame.place(x=50,y=20,width=680,height=520)
        ...
        current_course_frame.place(x=10,y=5,width=655,height=150)
        ...
        class_Student_frame.place(x=10,y=170,width=655,height=270)
        ...
        take_photo_btn.grid(row=0,column=4,padx=5,pady=20,sticky=W)

        #update photo button
        update_photo_btn=Button(btn_frame,text="Update Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        update_photo_btn.grid(row=0,column=5,padx=5,pady=20,sticky=W)
        ...
        search_frame.place(x=10,y=5,width=655,height=80)
        ...
        table_frame.place(x=10,y=90,width=655,height=400)
