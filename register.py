...
class Register:
    def __init__(self,root):
        ...
        bg_img.place(x=0,y=0,width=1536,height=768)

        frame= Frame(self.root,bg="#F2F2F2")
        frame.place(x=100,y=80,width=680,height=580)
        ...
        self.txtuser.place(x=53,y=225,width=270)
        ...
        self.combo_security.place(x=53,y=375,width=270)
        ...
        self.txtpwd.place(x=53,y=445,width=270)

        # ========================= Section 4-----Column 2=============================

        #label1 
        pwd =lb1= Label(frame,text="Password:",font=("times new roman",15,"bold"),fg="#002B53",bg="#F2F2F2")
        pwd.place(x=360,y=350)

        #entry1 
        self.txtuser=ttk.Entry(frame,textvariable=self.var_pwd,font=("times new roman",15,"bold"))
        self.txtuser.place(x=360,y=375,width=270)


        #label2 
        cpwd =lb1= Label(frame,text="Confirm Password:",font=("times new roman",15,"bold"),fg="#002B53",bg="#F2F2F2")
        cpwd.place(x=360,y=420)

        #entry2 
        self.txtpwd=ttk.Entry(frame,textvariable=self.var_cpwd,font=("times new roman",15,"bold"))
        self.txtpwd.place(x=360,y=445,width=270)

        # Checkbutton
        checkbtn = Checkbutton(frame,variable=self.var_check,text="I Agree the Terms & Conditions",font=("times new roman",13,"bold"),fg="#002B53",bg="#F2F2F2",cursor="hand2")
        checkbtn.place(x=220,y=500,width=270)


        # Creating Button Register
        loginbtn=Button(frame,command=self.reg,text="Register",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC",cursor="hand2")
        loginbtn.place(x=220,y=532,width=270,height=35)
