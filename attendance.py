...
class Attendance:
    ...
    def __init__(self,root):
        ...
        studentId_label.grid(row=0,column=0,padx=7,pady=5,sticky=W)
        ...
        table_frame.place(x=10,y=120,width=655,height=310)
        ...
        right_frame.place(x=760,y=20,width=680,height=520)
        ...
        table_frame.place(x=10,y=70,width=655,height=420)
