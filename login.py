...
class Login:
    def __init__(self,root):
        ...
        frame1.place(x=200, y=170, width=340, height=450)

        # Login Icon
        img1 = Image.open(r"Images_GUI\loginicon2.png")
        img1 = img1.resize((100, 100), Image.LANCZOS)
        self.photoimage1 = ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1, bg="#002B53")
        lb1img1.place(x=320, y=175, width=100, height=100)

        # Login Title
        get_str = Label(frame1, text="Login", font=("times new roman", 22, "bold"), fg="white", bg="#002B53")
        ...
        # Password Entry
        self.txtpwd = ttk.Entry(frame1, font=("times new roman", 15, "bold"), show="*")  # Added 'show' for masking password
        ...
        registerbtn.place(x=33, y=370, width=80, height=25)
        ...
        forgetbtn.place(x=110, y=370, width=150, height=25)
        ...
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            if row==None:
                ...
                if open_min>0:
                    ...
                    self.new_window=Toplevel(self.root)
                    self.app=main_module.Face_Recognition_System(self.new_window)
...
# =====================main program Face deteion system====================
    ...
    def close_all(self):
        # Destroy the login window and ensure the main window is destroyed too
        self.root.destroy()
        self.main.destroy_all()
